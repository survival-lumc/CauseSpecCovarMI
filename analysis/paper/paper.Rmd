---
title: "Missing covariates for competing risks models: an evaluation of available imputation methods."
author:
- name: E. F. Bonneville*
  num: a
- name: M. Resche-Rigon
...
address:
- num: a
  org: Medical Statistics, Department of Biomedical Data Sciences, Leiden University Medical Center, Leiden, The Netherlands
- num: b
  org: INSERM U1153, Statistic and Epidemiologic Research Center Sorbonne Paris Cité (CRESS), ECSTRA Team, Saint-LouisHospital, 75010 Paris, France
- num: c
  org: Paris Diderot University, Paris 7, SPC, Paris, France
- num: d
  org: SBIM, Saint-Louis Hospital, APHP, Paris, France
corres: "*Corresponding author \\email{e.f.bonneville@lumc.nl}"
presentaddress: Edouard F. Bonneville, Department of Biomedical Data Sciences, Leids University Medical Center, Postzone S5‐P, Postbus 9600, 2300 RC Leiden, The Netherlands
